import { CurrencyAmount, JSBI, Token, Trade } from '@forever9/mxswap-sdk'
import React, { useCallback, useContext, useEffect, useMemo, useState } from 'react'
import { ArrowDown } from 'react-feather'
import { ArrowDownIcon, Button, CardBody, IconButton, Text, useModal } from '@pancakeswap-libs/uikit'
...
const Swap = () => {
  ...
  return (
    <>
      ...
      <StyledDesc>Trade tokens in an instant</StyledDesc>
      <AppBody>
        <Wrapper id="swap-page">
          ...
          <CardBody>
            <AutoColumn gap="md">
              ...
              <AutoColumn justify="space-between" style={{display: 'none'}}>
