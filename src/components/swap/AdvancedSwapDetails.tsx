...
import { Trade, TradeType } from '@pureswap-libs/sdk'
import { Card, CardBody, Text } from '@pureswap-libs/uikit'
    ...
    <PureCard>
      <CardBody>
        <RowBetween style={{marginBottom: '10px'}}>
          <RowFixed>
            <PureText fontSize="14px">{isExactIn ? 'Minimum received' : 'Maximum sold'}</PureText>
